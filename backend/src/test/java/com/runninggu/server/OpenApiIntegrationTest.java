...
class OpenApiIntegrationTest extends PostgreSqlContainerSupport {
    ...
    void OpenAPI_문서를_공개한다() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/api/me/password']['put']").exists())
                .andExpect(jsonPath("$['paths']['/api/me/reauth']['post']").exists())
                .andExpect(jsonPath("$['paths']['/api/me']['delete']").exists())
                .andExpect(jsonPath(
                ...
                .andExpect(jsonPath("$.components.schemas.PasswordResetEmailRequest").exists())
