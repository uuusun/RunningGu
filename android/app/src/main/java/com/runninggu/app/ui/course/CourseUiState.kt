...
data class CourseUiState(
    ...
    /**
     * 걷기 스팟을 골랐는가. 골랐으면 화면이 **왜 저장이 안 되는지** 적는다. (§4.11-4 · #269)
     *
     * **P0 에서 걷기 스팟은 출발지가 되지 않는다** 🔒확정(#269). 그 장소를 새 출발지로
     * 삼아 다시 조회하는 안을 검토했지만 P1 로 미뤘다 — 출발지 이력·뒤로 가기 복원 규칙이
     * 같이 와야 하는데 그 계약이 아직 없다.
     *
