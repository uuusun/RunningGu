...
> 가드 해제·backend 재기동·HTTPS 재확인까지 완료했다. 이 8GiB 실행 시점에는 4GiB가 미시험이었다.
> 이후 [4GiB 전체 부하 시도](staging-4g-validation-20260905.md)는 중도 종료로 보존했고,
> 2026-09-06 별도 승인한 [4GiB 기본 운영 점검](staging-4g-closeout-20260906.md)을 완료했다.
> 아래 로컬 준비 기록과 [8GiB 실행 증거](api-load-ec2-8g-20260905.md)는 당시 상태다.
